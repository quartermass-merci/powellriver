...
window.INTERVIEWS = [
  { id: "craig_ewan",     name: "Craig Austin & Ewan Moir", role: "Mill Project CEO / COO",
    team: "pk_jen", format: "formal", duration: 45, day: "wed", locationId: "meridian",
    ...
    prep: "TENTATIVE — Joe hasn't connected yet as of Apr 24. Don't bank on Monday; push to later in the week. Ideal: mill site or Townsite setting.",
    status: "pending",
  },
  { id: "chris_mcdonough", name: "Chris McDonough", role: "Owner/Operator, High Quadz · PR local",
    ...
    prep: "Confirmed (Joe intro Apr 24). Late afternoon Monday.",
    status: "confirmed",
  },
  ...
  { id: "josh_rettie",    name: "Josh Rettie", role: "Head of Cultivation (Master Grower)",
    team: "pk_jen", format: "formal", duration: 45, day: "tue", locationId: "meridian",
    bio: "25+ years growing, breeding, and collecting rare genetics. ACMPR at home with 30+ unique cultivars, a living seed library. The deep craft voice of Meridian. (Joe noted: he may have inflated earlier numbers — Josh can confirm.)",
    prep: "Lead with his experience OUTSIDE Meridian — who he is as a grower — before getting into the genetics database. Joe's steer: the value in Josh's stories comes from who he is, not the internal process. Ask about his favourites. Ask what he's growing at home that he hasn't brought to Meridian yet.",
    status: "confirmed",
  },
  ...
  { id: "kelly_brooks",   name: "Kelly Brooks", role: "Cultivation, Crop Work Lead",
    ...
    prep: "AUDIO ONLY — Kelly has asked not to be on camera. She's happy to share stories verbally. Mike captures audio; Katie doesn't roll. Start with 'walk me through your day.'",
    status: "confirmed",
  },
  { id: "dave_lene",      name: "Dave Dowling + Lene Lindstrom", role: "Ex-mill workers, now at Meridian",
    ...
    prep: "Both confirmed (Joe, Apr 24). One question each: 'What's it like working in this building now vs. when it was the mill?'",
    status: "confirmed",
  },
  { id: "roundtable",     name: "Cultivation Roundtable", role: "Josh + Kelly Storm + Sam + Andrew",
    team: "both", format: "roundtable", duration: 30, day: "tue", locationId: "meridian",
    bio: "The four people who actually grow the cannabis (plus strategic lens), in one room, talking to each other. Andrew added per Joe's Apr 24 note; Kelly Brooks was never in this. Captures dynamics a one-on-one never will. Schedule AFTER individual interviews.",
    prep: "End of day. Keep it loose. Opener: 'What's the thing the four of you argue about most?' Closer: 'What would you want a brand to never get wrong about what you do?'",
    status: "confirmed",
  },
  { id: "brent_b",        name: "Brent B", role: "Wheelchair Weed Craft Cannabis — micro grower",
    ...
    prep: "Drive south, 30 min each way. First thing Wednesday. JOE'S WARNING (Apr 24): budgeted 45 min, stayed two hours. Build buffer + go in with a plan to wrap. Ask about why Powell River, why cannabis. Don't make the wheelchair the whole story.",
    status: "pending",
  },
  { id: "wayne_walsh",    name: "Wayne Walsh", role: "Newfoundland transplant, Meridian construction",
    ...
    bio: "Involved in the physical construction and launch of the Meridian facility. A Newfoundland transplant with a storyteller's instinct. Can speak to what it took to build this operation inside a former paper mill — the physical reality behind 'Ghosts in the Machine.' LEGALIZATION HOOK (Joe, Apr 24): Wayne was among the first five or ten people in line at the St. John's, NL dispensary that sold the first gram of legal cannabis in Canada on Oct 17, 2018. Very likely one of the first ten Canadians to legally buy cannabis. Major narrative hook.",
    prep: "Late morning. Ask about the build: what went wrong, what surprised him, what the building fought back on. Then: Oct 17, 2018 in St. John's — the first-hour-of-legalization line. Huge angle.",
    status: "pending",
  },
  ...
  { id: "tom_ligocki",    name: "Tom Ligocki", role: "Executive Director, Meridian 125W",
    team: "pk_jen", format: "formal", duration: 45, day: "mon", locationId: "airbnb",
    bio: "Executive Director. Requested a Monday-morning call (Joe, Apr 24) — wants to share directional things early and connect with PK before field days kick off.",
    prep: "Teams or Zoom. 30–45 min, 08:00 AM PT from the Airbnb. Directional share. Important to Tom to connect early. PK takes the call; rest of team starts field work at 09:00.",
    status: "confirmed",
  },
  { id: "collier_quinton", name: "Collier Quinton", role: "Runs Weathered Islands · Texada Island",
    team: "pk_jen", format: "formal", duration: 45, day: "wed", locationId: "texada",
    bio: "Runs Weathered Islands on Texada Island. Long-time local. Joe expects great stories. Texada is its own island across Malaspina Channel, accessed by the Westview–Blubber Bay ferry.",
    prep: "Joe reached out Apr 24 — awaiting availability. Ferry from Westview to Blubber Bay, ~35 min sailing. Plan half a day for the trip including travel. If Collier confirms, likely Wednesday afternoon.",
    status: "pending",
  },
];
...
window.CONTACTS = {
  ...
  tom_ligocki: {
    email: "",
    linkedin: lnk("Tom Ligocki Meridian Executive Director"),
    company: "Meridian 125W",
    companyUrl: "https://meridian125w.com",
    intro: "Monday 08:00 AM PT video call — Tom requested early connect, has directional things to share.",
  },
  collier_quinton: {
    email: "",
    linkedin: lnk("Collier Quinton Weathered Islands Texada"),
    company: "Weathered Islands",
    companyUrl: "",
    intro: "Joe reached out Apr 24 — awaiting Collier's availability. Worth going to Texada for.",
  },
};
...
window.SCHEDULE_SEED = {
  ...
  mon: [
    // PK + Jen lane
    T("mon", "08:00",  45, "pk_jen", "formal",    "Tom Ligocki · remote",                        { locationId: "airbnb", interviewId: "tom_ligocki", brief: "30–45 min Teams/Zoom from the Airbnb. Tom wants an early connect + directional share.", locked: true }),
    T("mon", "09:00",  90, "pk_jen", "archival",  "qathet Museum & Archives — deep dive",       { locationId: "museum", brief: "Photos, names, dates, citations. (Shifted from 08:30 to make room for Tom.)" }),
    ...
    T("mon", "13:30",  60, "pk_jen", "buffer",    "Open slot (Craig & Ewan deferred)",           { locationId: "meridian", brief: "Joe's Apr 24 update: Craig & Ewan not banked for Monday; pushed to later in the week. Use this slot for ad-hoc outreach, notes, or a walk." }),
    T("mon", "15:00",  30, "pk_jen", "formal",    "Chris McDonough",                             { locationId: "meridian", interviewId: "chris_mcdonough", brief: "High Quadz, Meridian's first customer. Proof of product without marketing.", locked: true }),
  ...
  wed: [
    ...
    // Mike + Katie lane
    T("wed", "08:00", 150, "mike_katie", "broll",   "Lund drive · northern coast · Tla'amin B-roll", { locationId: "lund", brief: "Respectful, public areas only. Joe's rec: stop at Nancy's Bakery in Lund — cinnamon buns, possible Michael Bublé sighting." }),
...
window.ACTION_ITEMS = [
  ...
  { owner: "Joe",  text: "Dave Dowling + Lene Lindstrom confirmed for portraits",            status: "confirmed", intervieweeId: "dave_lene", template: "warm_joe" },
  ...
  { owner: "Joe",  text: "Reconnect with Craig & Ewan — reschedule later in the week (not banked for Mon)", status: "pending", intervieweeId: "craig_ewan", template: "warm_joe" },
  ...
  { owner: "Joe",  text: "Collier Quinton · Weathered Islands, Texada — awaiting availability", status: "in progress", intervieweeId: "collier_quinton", template: "warm_joe" },
  { owner: "PK",   text: "Chris McDonough confirmed for Monday late afternoon",             status: "confirmed", intervieweeId: "chris_mcdonough", template: "confirm" },
  { owner: "PK",   text: "Tom Ligocki · Monday 08:00 AM video call confirmed",              status: "confirmed", intervieweeId: "tom_ligocki",     template: "confirm" },
  { owner: "PK",   text: "Reach out to Brent B for Wednesday 8 AM (plan to wrap)",          status: "pending",   intervieweeId: "brent_b",     template: "cold_pk" },
  { owner: "PK",   text: "Reach out to Wayne Walsh for Wednesday 11 AM (lead with Oct 17 2018 angle)", status: "pending", intervieweeId: "wayne_walsh", template: "cold_pk" },
